...
async def test_broadcast(chat, match):
    ...
    for user in users:
        ...
        Тез орада каналимизда яхши янгиликлар бўлиши кутилмоқда. Каналимизни кузатиб боринг.
        👉 [Канал манзили](https://t.me/vodiybozor) 👈

        PS.: Бот битиши билан сизга албатта телеграм ёки смс хабар жўнатамиз. Биз учун ҳар бир каналимиз аъзоси қадрлидир. Вақти-вақти билан бот юбориб турадиган хабарлар сизни кўп ҳам безовта қилмайди деган умиддамиз.
        ''')
